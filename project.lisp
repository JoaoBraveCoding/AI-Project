...
(defun resultado(estado accao)
  (let ((estadoNovo (copia-estado estado))
    ...
    (loop while (and (> linha 2) (descer peca linha coluna (estado-tabuleiro estado))) do
          (setf linha (- linha 1)))
  ...
  (let ((accoes               (problema-accoes problema))
    ...
    (loop while (not (eql estados-por-avaliar nil))
          do(progn
              ...
              (princ (estado-pecas-por-colocar (nth 0 par-estado-accao)))
